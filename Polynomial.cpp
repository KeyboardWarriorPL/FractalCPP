...
QString Polynomial::ToString() const {
    ...
    for (auto i = factors.size()-1; i > 0; i++) {
        ...
        s.append("z^");
        s.append(QString{to_string(i).data()});
        s.append(" + ");
    }
