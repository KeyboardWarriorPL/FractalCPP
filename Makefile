...
# Generated by qmake (2.01a) (Qt 4.8.7) on: czw. maj 9 22:26:47 2019
# Project:  Fractal.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile Fractal.pro
#############################################################################
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents FComplex.h Polynomial.h Julia.h .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents main.cpp FComplex.cpp Polynomial.cpp Julia.cpp .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents front.ui .tmp/Fractal1.0.0/ && (cd `dirname .tmp/Fractal1.0.0` && $(TAR) Fractal1.0.0.tar Fractal1.0.0 && $(COMPRESS) Fractal1.0.0.tar) && $(MOVE) `dirname .tmp/Fractal1.0.0`/Fractal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Fractal1.0.0
