...
# Generated by qmake (2.01a) (Qt 4.8.7) on: pt. maj 17 15:59:33 2019
# Project:  Fractal.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents FComplex.h Polynomial.h Julia.h CustomGraphics.h FrontForm.h .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents main.cpp FComplex.cpp Polynomial.cpp Julia.cpp CustomGraphics.cpp FrontForm.cpp .tmp/Fractal1.0.0/ && $(COPY_FILE) --parents front.ui .tmp/Fractal1.0.0/ && (cd `dirname .tmp/Fractal1.0.0` && $(TAR) Fractal1.0.0.tar Fractal1.0.0 && $(COMPRESS) Fractal1.0.0.tar) && $(MOVE) `dirname .tmp/Fractal1.0.0`/Fractal1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Fractal1.0.0
...
compiler_moc_header_make_all: moc_CustomGraphics.cpp moc_FrontForm.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_CustomGraphics.cpp moc_FrontForm.cpp
